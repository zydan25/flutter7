...
- **اسم التطبيق**: شبيك (`android:label="شبيك"`)
- **حزمة التطبيق (Package Name)**: `com.shopik.app`
- **الأيقونات الرسمية**: مُولدة لجميع مقاسات كثافة الشاشة `mipmap-mdpi`, `hdpi`, `xhdpi`, `xxhdpi`, `xxxhdpi`
- **مفتاح التوقيع**: `shopik_flutter/android/app/shopik-release.jks`
- **ملف التوقيع**: `shopik_flutter/android/key.properties`
