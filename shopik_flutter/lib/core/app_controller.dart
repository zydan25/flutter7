...
class AppController extends ChangeNotifier {
  ...
  Future<bool> biometricQuickLogin() async {
    ...
    final savedPhone = prefs.getString('saved_phone') ?? '771642093';
    user = UserProfile(
      id: 1,
      phone: savedPhone,
  ...
  void _preloadCoreServices() {
    ...
    idsToPreload.addAll([1, 2, 4, 8, 9, 13, 14, 15, 16, 18, 19, 20, 21, 23, 24]);
  ...
  Future<Map<String, dynamic>?> loadServiceContract(int serviceId) async {
    if (serviceDetailsCache.containsKey(serviceId)) {
