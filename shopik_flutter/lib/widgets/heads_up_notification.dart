...
class HeadsUpNotification {
  ...
  /// Show a floating heads-up banner notification at the top of the screen.
  static void show(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                ...
                                child: const Text(
                                  'الآن',
                                  style: TextStyle(fontSize: 9, color: Colors.slate),
                                ),
                              ),
                            ],
                          ),
                    ...
                    IconButton(
                      icon: const Icon(Icons.close, size: 16, color: Colors.slate),
